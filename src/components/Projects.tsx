...
const projects = [
  {
    ...
    description: "ML-powered demand forecasting system reducing overstock by 32% for a national retail chain.",
  ...
  },
  {
    ...
    description: "End-to-end onboarding workflow connecting HRIS, Slack, Notion, and email into a zero-touch pipeline.",
  ...
  },
  {
    ...
    category: "AI Integration" as Category,
    description: "Real-time churn risk scoring engine integrated into a SaaS CRM, improving retention by 21%.",
  ...
  },
  {
    ...
    category: "AI Integration" as Category,
    description: "LangChain-powered logistics intelligence platform with natural language querying and route optimization.",
    tags: ["LangChain", "Next.js", "FastAPI", "Redis"],
  ...
  },
  {
    ...
    category: "Automation" as Category,
    description: "Automated document ingestion, OCR extraction, and classification system for a financial services firm.",
  ...
  },
  {
    ...
    category: "AI Integration" as Category,
    description: "AI triage system that auto-classifies, prioritizes, and routes support tickets — 85% automation rate.",
      ...
      <div className="relative z-10 max-w-7xl mx-auto px-6">
        ...
        >
          ...
          <p className="text-white/50 text-lg max-w-xl mx-auto">
            A selection of systems we&apos;ve built — each one solving a real business problem with precision engineering.
          </p>
        </motion.div>
          ...
          <AnimatePresence mode="popLayout">
            {filtered.map((project, i) => (
              <motion.div
                ...
                className="break-inside-avoid mb-5 group relative overflow-hidden rounded-sm border border-white/8 cursor-pointer"
                whileHover={{ y: -3 }}
              >
                {/* Gradient header */}
                <div
                  className={`bg-gradient-to-br ${project.gradient} ${
                    project.size === "large" ? "h-40" : "h-24"
                ...
                {/* Card content */}
                <div className="bg-dark border-t border-white/5 p-5 group-hover:bg-blue-vivid/5 transition-colors duration-300">
